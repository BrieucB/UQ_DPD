...
e1["Problem"]["Computational Model"] = lambda sampleData: viscosity_analytic(sampleData, getReferencePointsVisco()[2:3])
e1["Problem"]["Type"] = "Bayesian/Reference"
e1["Problem"]["Likelihood Model"] = "Normal"
e1["Problem"]["Reference Data"] = getReferenceDataVisco()[2:3]

print(getReferencePointsVisco()[2:3], getReferenceDataVisco()[2:3])

# Configuring the problem's random distributions
e1["Distributions"][0]["Name"] = "Uniform_rc"
e1["Distributions"][0]["Type"] = "Univariate/Uniform"
e1["Distributions"][0]["Minimum"] = 1.3
e1["Distributions"][0]["Maximum"] = 1.6

e1["Distributions"][1]["Name"] = "Uniform_gamma"
e1["Distributions"][1]["Type"] = "Univariate/Uniform"
e1["Distributions"][1]["Minimum"] = 90.0
e1["Distributions"][1]["Maximum"] = 110.0
...
e1["Variables"][1]["Name"] = "sigma_c"
e1["Variables"][1]["Prior Distribution"] = "Uniform_sigma"
