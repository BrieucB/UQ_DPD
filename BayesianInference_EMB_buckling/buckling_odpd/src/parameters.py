...
filename = 'parameter/parameters' + args.simnum + '.yaml' # params calculated
filename_prms = 'parameter/parameters.prms' + args.simnum + '.yaml' # force field membrane forces
filename_obmd = 'parameter/parameters.obmd' + args.simnum + '.yaml' # obmd params 
filename_default = 'parameter/parameters-default' + args.simnum + '.yaml' # generated by generate.py
