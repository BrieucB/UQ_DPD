...
e["Distributions"][1]["Mean"] = "mu_gamma"
e["Distributions"][1]["Standard Deviation"] = "sig_gamma" 
...
e["Distributions"][4]["Minimum"] = 1.0
e["Distributions"][4]["Maximum"] = 10.0

# Prior of mu_gamma
e["Distributions"][5]["Name"] = "Uniform 2"
e["Distributions"][5]["Type"] = "Univariate/Uniform"
e["Distributions"][5]["Minimum"] = 50.0
e["Distributions"][5]["Maximum"] = 150.0
...
### [ERROR] : RuntimeError: Sub-problem 0 contains a different number of variables (0) than conditional priors in the Hierarchical Bayesian (Psi) problem (2).
###  + From ../source/modules/problem/hierarchical/psi/psi.cpp:48
